...
----------------------------------------
[Script]
http-request ^https?:\/\/(.+\.)?boxjs\.(com|net) script-path=https://raw.githubusercontent.com/Centralmatrix3/Matrix-io/master/Loon/Scripts/BoxRewrite.js, requires-body=true, timeout=120, tag=BoxJs
